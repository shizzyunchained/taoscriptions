...
remainder exact WebP image bytes`}</code></pre>
        ...
        <Chapter number="12" title="Marketplace design" id="marketplace">
          ...
          <p>The testnet market supports direct ownership transfers and fixed-price discovery listings. Wallets sign exact payloads, relayers never control artifacts, and the index verifies the seller at the current nonce. A payment-plus-remark prototype exists as research code, but it is not exposed as a safe purchase path because Subtensor does not enforce Relics&apos; index-derived ownership state.</p>
        </Chapter>
