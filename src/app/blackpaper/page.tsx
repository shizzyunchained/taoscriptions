...
remainder exact WebP image bytes`}</code></pre>
        ...
        <Chapter number="12" title="Marketplace design" id="marketplace">
          ...
          <p>The testnet market supports direct transfers and fixed-price Sale V2 orders. Wallets sign exact payloads; relayers never control artifacts; indexes verify the seller at the current nonce; and settlement fails closed unless ownership, price, payment, finality, and execution are bound into one atomic outcome.</p>
        </Chapter>
