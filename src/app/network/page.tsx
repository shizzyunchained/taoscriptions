  ...
  return (
    <main className="site-shell inner-site">
      ...
      <nav className="nav" aria-label="Main navigation">
        <SiteMark />
        <div className="nav-links"><Link href="/#forge">Forge</Link><Link href="/explore">Explore</Link><Link href="/network">Network</Link><Link href="/docs">Docs</Link><span className="chain-status prototype"><i aria-hidden="true" />Simulation</span></div>
      </nav>
