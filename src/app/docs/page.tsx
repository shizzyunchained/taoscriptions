  ...
  System.remark_with_event(relic_payload)
          ...
          <Section id="library" label="10 / Reference library" title="Go deeper without hunting through the repository.">
            <div className="manual-library">
              ...
              <a href="https://github.com/shizzyunchained/taoscriptions/blob/feat/neural-relics-v1/docs/SETTLEMENT_V2.md" target="_blank" rel="noreferrer"><span>Settlement research</span><strong>Native contract v2</strong><p>The buyer no-loss invariant, contract-owned Relics, verified prototype evidence, and deployment gates.</p></a>
